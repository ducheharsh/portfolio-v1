    ...
    return (
        ...
        <div className="ml-12 antialiased pt-4 relative">
          {Content.map((item, index) => (
            <div key={`content-${index}`} className=" xl:flex w-full col-span-4 group">
            ...
            <div className="isolate md:mt-28 xl:ml-6 h-[500px] px-4 text-sm ring-1 bg-white/5 backdrop-blur-sm ring-white/10 shadow-lg py-2 rounded-md text-white xl:w-[180%] w-[100%] ">
                            {item.description}
              </div>
