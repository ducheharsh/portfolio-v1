...
export const projects = [
  {
    ...
    title: "ReactJs",
    description:
      "A popular JavaScript library for building user interfaces, particularly single-page applications, known for its efficient update and rendering of components.",
  ...
  {
    src: "https://p1.hiclipart.com/preview/549/476/37/database-logo-carnegie-mellon-university-database-management-system-relational-database-management-system-librariesio-data-mining-machine-learning-red-png-clipart.jpg",
    title: "SQL and NoSQL",
    description:
      "Two types of database management systems. SQL databases are relational and use structured query language, while NoSQL databases are non-relational and offer flexible schemas for unstructured data.",
  ...
  {
    src: "https://media.dev.to/cdn-cgi/image/width=320,height=320,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Forganization%2Fprofile_image%2F1608%2F0f93b179-76bf-4ee7-a838-e8222fbef062.png",
    title: "Prisma",
    description:
      "An open-source database toolkit that includes an ORM for Node.js and TypeScript, simplifying database access with type-safety and auto-completion features.",
...
Create, edit, and prioritize tasks efficiently.
Organize tasks into categories or projects.
Seamlessly sync tasks across devices.
Intuitive interface for optimal user experience.
Robust backend for reliable data management.`,
    technologies: [
      "Next.js",
      "Typescript",
      "PostgreSQL",
    ...
    links: [
      {
        type: "Website",
        href: "https://todo-app-blond-sigma.vercel.app/signup",
    ...
    image: "",
    video:
      "https://pub-9791152ac1134a02a51646c306b4738b.r2.dev/1722595970372877.mp4",
  },
  {
    title: "Minmalist",
    ...
    links: [
      {
        type: "Source",
        href: "https://github.com/ducheharsh/medium-project",
        icon: <Icons.github className="size-3" />,
      },
      {
        type: "Website",
    ...
    image: "",
    video:
      "https://pub-9791152ac1134a02a51646c306b4738b.r2.dev/1722591802653398.mp4",
  },
  {
    title: "theWallet",
    href: "https://github.com/ducheharsh/theWallet",
    dates: "Jun 2024 - Jul 2024",
    active: true,
    description:
      "A simple wallet application (creating user + merchant side applications managed in a monorepo with implementaion of transactions) consisting two express backends to handle bank weebhook and to simulate the bank API and an independent CI/CD pipeline for deployment.",
    technologies: [
      "Turborepo",
      "Next.js",
      "Typescript",
    ...
    image: "",
    video:
      "https://pub-9791152ac1134a02a51646c306b4738b.r2.dev/1722594371516585.mp4",
  },
  {
    title: "Youtubed",
    href: "",
